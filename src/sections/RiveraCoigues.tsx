...
import { MapPin, Send, ChevronDown, Trees, Droplets, Shield, Check } from 'lucide-react';
    ...
    try {
      await fetch('https://formsubmit.co/ajax/insideproevents@gmail.com', {
        ...
        body: JSON.stringify({
          ...
          _subject: 'Nuevo contacto desde Ribera de los Coigües',
        }),
      });
        ...
        {[
          ...
          },
          {
          ...
          },
           {
            ...
            description: 'en un proyecto único'
          }
        ].map((feature, index) => (
           <div 
            key={index}
