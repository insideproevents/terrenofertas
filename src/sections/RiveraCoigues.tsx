      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            {/* Forest image */}
            <img \n              src="/rivera-coigues/forest.jpg"\n              alt="Bosque Nativo"\n              className="w-full h-[480px] object-cover rounded-2xl shadow-2xl"\n            />\n          </div>\n\n          {/* Pricing Cards */}\n          <div className="grid lg:grid-cols-3 gap-8 mt-16">\n            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-500">\n              <h3 className="font-display text-2xl text-white mb-6">Terrenos Interiores desde</h3>\n              <div className="font-display text-4xl lg:text-5xl text-[#5bc0de] mb-4">$6.990.000</div>\n              <div className="text-white/80 mb-6">Cuota desde $291.000/ mes</div>\n              <div className="bg-[#5bc0de]/20 border border-[#5bc0de]/50 text-[#5bc0de] font-semibold py-2 px-4 rounded-full">\n                $3.000.000 dcto.\n              </div>\n            </div>\n            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-500">\n              <h3 className="font-display text-2xl text-white mb-6">Terrenos Orilla de río desde</h3>\n              <div className="font-display text-4xl lg:text-5xl text-[#5bc0de] mb-4">$14.990.000</div>\n              <div className="text-white/80 mb-6">Cuota desde $625.000/ mes</div>\n              <div className="bg-[#5bc0de]/20 border border-[#5bc0de]/50 text-[#5bc0de] font-semibold py-2 px-4 rounded-full">\n                $3.000.000 dcto.\n              </div>\n            </div>\n            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-500">\n              <h3 className="font-display text-2xl text-white mb-6">Terrenos Orilla de camino desde</h3>\n              <div className="font-display text-4xl lg:text-5xl text-[#5bc0de] mb-4">$10.990.000</div>\n              <div className="text-white/80 mb-6">Cuota desde $458.000/ mes</div>\n              <div className="bg-[#5bc0de]/20 border border-[#5bc0de]/50 text-[#5bc0de] font-semibold py-2 px-4 rounded-full">\n                $3.000.000 dcto.\n              </div>\n            </div>\n          </div>\n\n          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">\n
            {[
              {
                icon: Trees,
